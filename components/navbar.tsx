...
export async function Navbar() {
  ...
  return (
    <nav className="flex justify-center w-full h-header sticky top-0 bg-black/50 backdrop-blur-lg backdrop-saturate-200 shadow-[inset_rgba(255_255_255_/_0.15)_0_-1px] z-40">
