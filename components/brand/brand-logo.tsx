  ...
  return (
    <div className="relative aspect-square h-full w-full">
      ...
      <svg
        ...
        viewBox="0 0 490.638 490.638"
        className="absolute inset-0 h-full w-full fill-background stroke-foreground stroke-[0.6rem]"
      >
        <title>feather</title>
        <path
          d="M396.776,195.483c67.294-58.917,56.957-182.108,44.529-194.552c-6.945-6.947-23.243,26.361-66.664,53.077
