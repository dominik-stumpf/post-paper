import { pbCookieKey } from '@/server-data';

export async function auth() {
  const cookie = request.cookies.get(pbCookieKey);

  if (cookie === undefined) {
    throw new Error('no cookie here');
  }
  ...
  console.log('middleware ran', pb.authStore.isValid);
}
