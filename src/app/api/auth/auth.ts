...
export const config = {
  providers: [
    ...
    // }),
    // FortyTwoSchool({
    //   clientId: process.env.AUTH_FORTYTWOSCHOOL_ID,
    //   clientSecret: process.env.AUTH_FORTYTWOSCHOOL_SECRET,
    // }),
    // Foursquare({
    //   clientId: process.env.AUTH_FOURSQUARE_ID,
    //   clientSecret: process.env.AUTH_FOURSQUARE_SECRET,
    // }),
    // Freshbooks({
    //   clientId: process.env.AUTH_FRESHBOOKS_ID,
    //   clientSecret: process.env.AUTH_FRESHBOOKS_SECRET,
    // }),
    // Fusionauth({
    ...
    // }),
    // Mailchimp({
    //   clientId: process.env.AUTH_MAILCHIMP_ID,
    //   clientSecret: process.env.AUTH_MAILCHIMP_SECRET,
    // }),
    // Mailru({
    //   clientId: process.env.AUTH_MAILRU_ID,
    //   clientSecret: process.env.AUTH_MAILRU_SECRET,
    // }),
    // Medium({
    //   clientId: process.env.AUTH_MEDIUM_ID,
    //   clientSecret: process.env.AUTH_MEDIUM_SECRET,
    // }),
    // Naver({
    ...
    // }),
    // Onelogin({
    //   clientId: process.env.AUTH_ONELOGIN_ID,
    //   clientSecret: process.env.AUTH_ONELOGIN_SECRET,
    // }),
    // Osso({
    //   clientId: process.env.AUTH_OSSO_ID,
    //   clientSecret: process.env.AUTH_OSSO_SECRET,
    //   issuer: process.env.AUTH_OSSO_ISSUER,
    // }),
    // Osu({
